...
1. Copy config/application.example.yml to config/application.yml and customize it with your credentials for:
  * mandrill
  * amazon S3
  * mailchimp
  * rollbar (for production)

2. Create the postrgesql user and dev database both named  @merciedgar@
